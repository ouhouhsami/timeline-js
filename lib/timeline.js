...
Timeline.prototype.updateGUI = function() {
	...
	for(var i=0; i<this.options.numberOfTracks; i++){
		this.drawLine(0, i*(this.options.height-this.options.scaleHeight)/this.options.numberOfTracks+this.options.scaleHeight,this.width,i*(this.options.height-this.options.scaleHeight)/this.options.numberOfTracks+this.options.scaleHeight,'#222')
	}
